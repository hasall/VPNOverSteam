...
public:
	...
	// (Or you can configure your game so that it is passed on the command line instead.  This is a deprecated path; ask us if you ((ISteamController*)iSteamMatchmaking)ly need this.)
